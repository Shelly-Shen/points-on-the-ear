 ...
 $.ajax({
    ...
    data: {diseaseCategoryId: dId},
     success:function(data){
      $('.main-class').append('<p class="main-class-attention"><span class="main-class-span">疾病描述:</span>'+data.diseaseDescription+'</p><button class="btn am-btn-primary">查看治疗方案</button>');
      $('.btn').click(function(){
        var mod=[]; 
        var arr=[];
        var vid=[];
        ...
        $('.main-class').append('</br><video src='+vid[0]+'  width=100% height=300px controls="controls" id="myvideo">');
